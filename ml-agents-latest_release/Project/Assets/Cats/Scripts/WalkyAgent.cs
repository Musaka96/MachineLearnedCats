...
public class WalkyAgent : Agent
{
    ...
    public float respawnAreaRange = 10f;
    ...
    public override void AgentReset()
    {
        ...
        //myLaser.transform.localScale = new Vector3(0f, 0f, 0f);
        this.transform.localPosition = new Vector3(Random.Range(-this.respawnAreaRange, this.respawnAreaRange),
            3f, Random.Range(-this.respawnAreaRange, this.respawnAreaRange));
